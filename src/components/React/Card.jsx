      ...
      <section className="grid grid-cols-5 gap-4">
        {pokemon.results?.map((item) => (
          <a key={item.name} href={`/pokedex/${item.name}`}>
            <div className="bg-slate-100 rounded-md transition-transform duration-200 ease-in-out hover:translate-y-2">
              ...
              <div className="py-4">
                <p className="text-slate-800 text-lg font-bold text-center">
                  {item.name}
                </p>
              </div>
            </div>
